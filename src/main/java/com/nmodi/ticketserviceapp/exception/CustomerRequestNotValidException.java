 ...
 */
public class CustomerRequestNotValidException extends RuntimeException {
     ...
     */
    public CustomerRequestNotValidException() {
     ...
     */
    public CustomerRequestNotValidException(String message) {
        this(message, null);
    }
     ...
     */
    public CustomerRequestNotValidException(String message, Throwable cause) {
        super(message, cause);
